 ...
 * 
 */
@WebServiceClient(name = "FilmWebCrudServiceService", targetNamespace = "http://lab2/", wsdlLocation = "http://localhost:8081/FilmService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FILMWEBCRUDSERVICESERVICE_QNAME = new QName("http://lab2/", "FilmWebCrudServiceService");
    ...
    public FilmService getFilmServicePort() {
        return super.getPort(new QName("http://lab2/", "FilmServicePort"), FilmService.class);
    }
    ...
    public FilmService getFilmServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab2/", "FilmServicePort"), FilmService.class, features);
    }
