...
public class ObjectFactory {
    ...
    private final static QName _DeleteFilm_QNAME = new QName("http://lab2/", "deleteFilm");
    private final static QName _FindFilmsResponse_QNAME = new QName("http://lab2/", "findFilmsResponse");
    private final static QName _FindFilms_QNAME = new QName("http://lab2/", "findFilms");
    private final static QName _UpdateFilm_QNAME = new QName("http://lab2/", "updateFilm");
    private final static QName _DeleteFilmResponse_QNAME = new QName("http://lab2/", "deleteFilmResponse");
    private final static QName _InsertFilm_QNAME = new QName("http://lab2/", "insertFilm");
    private final static QName _InsertFilmResponse_QNAME = new QName("http://lab2/", "insertFilmResponse");
    private final static QName _UpdateFilmResponse_QNAME = new QName("http://lab2/", "updateFilmResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab2/", name = "deleteFilm")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab2/", name = "findFilmsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab2/", name = "findFilms")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab2/", name = "updateFilm")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab2/", name = "deleteFilmResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab2/", name = "insertFilm")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab2/", name = "insertFilmResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab2/", name = "updateFilmResponse")
